        ...
        try {
            ...
            xmlhttp.onreadystatechange = function() {
                ...
                if (xmlhttp.readyState == 4) {
                    ...
                    VersionCompare_Async('2.0.00000', CurrentPluginVersion)
                }
            }
...
function CheckForPlugInUEC_Async()
{
    ...
    cadesplugin.async_spawn(function *() {
        ...
        if(!isActualVersion)
        {
            setStateForPlugin("yellow", "Плагин загружен, но он не поддерживает УЭК.");
        }
        else
        {
            setStateForPlugin("green", "Плагин загружен");
            ...
            {
                setStateForPlugin("yellow", "Плагин загружен. Не установлен УЭК CSP.");
            }
        }
        document.getElementById('PlugInVersionTxt').innerHTML = "Версия плагина: " + (yield CurrentPluginVersion.toString());
